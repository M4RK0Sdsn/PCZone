...
<body>
    ...
    <div id="main-content">
        ...
        <!-- Campo de búsqueda -->
        <input type="text" id="searchInput" placeholder="Buscar contactos..." onkeyup="buscarContactos()">
        ...
        <div id="formPopupEmpleado" class="form-popup" style="display: none;">
            <div class="form-container">
                ...
                <form action="Controllers/ContactosController.php" method="POST">
                    ...
                    <input type="text" id="contraseñaUsuario" name="contraseñaUsuario" required>
    ...
    <script>
        ...
        function buscarContactos() {
            let tabla = document.querySelector('input[name="radio"]:checked').value;
            let input = document.getElementById("searchInput").value.toLowerCase();
            fetch(`Controllers/ContactosController.php?tabla=${tabla}&query=${input}`)
                ...
                .then(data => {
                    ...
                    data.forEach(contacto => {
                        ...
                        Object.values(contacto).forEach(valor => {
        ...
        function cargarDatos(tabla) {
            fetch(`Controllers/ContactosController.php?tabla=${tabla}`)
                .then(response => response.json())
                .then(data => {
                    let thead = document.getElementById("contactosHeader");
                    let tbody = document.getElementById("contactosBody");
                    thead.innerHTML = ""; // Limpiar encabezados
                    tbody.innerHTML = ""; // Limpiar datos
